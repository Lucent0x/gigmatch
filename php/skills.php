    ...
    <main>
        ...
        <section class="sect" id="mid">
            ...
            <div class="box box1">
                <div class="card">
                    <div class="left"> 
                         <div class="plus button is-primary is-light is-small"><i class="fa-solid fa-plus"></i></div>
                        <div class="bold">UI Design Program</div>
                    </div>
                <div class="right">
                ...
                <div class="card">
                    <div class="left">
                        <div class="plus button is-primary is-light is-small"><i class="fa-solid fa-plus"></i></div>
                        <div class="bold">Digital Marketing Program</div>
                    </div>
                    <div class="right">
                        <img src="../utils/IMG_0212.JPG" alt="">
                    </div>
                ...
                <div class="card">
                    <div class="left">
                        <div class="plus button is-primary is-light is-small"><i class="fa-solid fa-plus"></i></div>
                        <div class="bold"> Graphics Design Program</div>
                    </div>
                    <div class="right">
                        <img src="../utils/IMG_0212.JPG" alt="">
                    </div>
